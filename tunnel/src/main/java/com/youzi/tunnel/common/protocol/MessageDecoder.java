...
public class MessageDecoder extends LengthFieldBasedFrameDecoder {
    ...
    @Override
    protected com.youzi.tunnel.common.protocol.ProxyMessage decode(ChannelHandlerContext ctx, ByteBuf in2) throws Exception {
        /**
        ...
        com.youzi.tunnel.common.protocol.ProxyMessage msg = new com.youzi.tunnel.common.protocol.ProxyMessage();
        byte type = in.readByte();

        msg.setType(ProxyMessage.TYPE.LINK.byValue(type));
