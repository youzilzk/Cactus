...
import com.youzi.tunnel.client.handlers.TunnelServerChannelHandler;
import com.youzi.tunnel.client.manager.ChannelManager;
import com.youzi.tunnel.client.manager.TunnelManager;
import com.youzi.tunnel.client.work.UserClientBootstrap;
            ...
            serverBootstrap.group(serverBossGroup, serverWorkerGroup)
                    ...
                    .childHandler(new ChannelInitializer<SocketChannel>() {
                        ...
                        protected void initChannel(SocketChannel channel) {
                            ...
                            try {
                                //请求开启链路, 绑定端口到服务端的链路
                                ChannelFuture future = com.youzi.tunnel.client.work.UserClientBootstrap.getBootstrap().connect(UserClientBootstrap.getInetSocketAddress()).sync();
                                // 连接后端服务器成功
                                if (future.isSuccess()) {
                                    //绑定链路
